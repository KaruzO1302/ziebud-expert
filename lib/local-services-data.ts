...
export const localServices: LocalService[] = [
  ...
  },
  {
    ...
    title: "Czyszczenie przewodów i pionów",
    heroTitle: "Czyszczenie przewodów i pionów — wspólnoty i firmy we Wrocławiu",
    eyebrow: "Serwis przewodów",
    tagline:
      "Piony, poziomy, studnie i przyłącza na budynkach wielorodzinnych, w lokalach i na obiektach technicznych. ZIĘBUD Expert, tel. 602 481 688.",
    metaTitle: "Czyszczenie przewodów i pionów — ZIĘBUD Expert Wrocław",
    metaDescription:
      "ZIĘBUD Expert czyści piony, poziomy, studnie i przyłącza na obiektach we Wrocławiu. WUKO, kamera TV. Tel. 602 481 688.",
    keywords: [
      "czyszczenie pionów kanalizacyjnych wrocław",
      "serwis przewodów wspólnota",
      "wuko obiekty firmowe wrocław",
    ],
    icon: Waves,
    trenchless: false,
