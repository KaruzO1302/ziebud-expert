...
export const districtServices: DistrictService[] = [
  // 1. WUKO Krzyki
  {
    ...
    districtName: "Krzyki",
    serviceName: "WUKO",
    metaTitle: "WUKO Krzyki Wrocław — czyszczenie kanalizacji | ZIEBUD Expert",
  ...
  // 2. Udrażnianie Krzyki
  {
    ...
    metaTitle: "Udrażnianie rur Krzyki Wrocław — zatory i odpływy | ZIEBUD Expert",
  ...
  // 3. Inspekcja TV Krzyki
  {
    ...
    metaTitle: "Inspekcja TV kanalizacji Krzyki Wrocław — kamera do rur | ZIEBUD Expert",
  ...
  // 4. WUKO Fabryczna
  {
    ...
    serviceName: "WUKO",
    metaTitle: "WUKO Fabryczna Wrocław — czyszczenie kanalizacji dla firm | ZIEBUD Expert",
  ...
  // 5. Udrażnianie Fabryczna
  {
    ...
    districtName: "Fabryczna",
    serviceName: "Udrażnianie rur",
    metaTitle: "Udrażnianie rur Fabryczna Wrocław — firmy i obiekty | ZIEBUD Expert",
  ...
  // 6. Inspekcja TV Fabryczna
  {
    ...
    districtName: "Fabryczna",
    serviceName: "Inspekcja TV kanalizacji",
    metaTitle: "Inspekcja TV kanalizacji Fabryczna Wrocław — kamera dla firm | ZIEBUD Expert",
